...
import { i as hasProtocol, l as isScriptProtocol, j as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as baseURL, o as createHooks, q as executeAsync, e as createError$1, t as toRouteMatcher, v as createRouter$1, x as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Be-D4ARN.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CAuLVKw4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CxfFEaGU.mjs'));
