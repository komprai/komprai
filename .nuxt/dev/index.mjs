...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, setCookie, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, getRouterParam, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/inonjs/workspace/komprai/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/inonjs/workspace/komprai/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/inonjs/workspace/komprai/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///Users/inonjs/workspace/komprai/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/inonjs/workspace/komprai/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/inonjs/workspace/komprai/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/inonjs/workspace/komprai/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/inonjs/workspace/komprai/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/inonjs/workspace/komprai/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/inonjs/workspace/komprai/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/inonjs/workspace/komprai/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///Users/inonjs/workspace/komprai/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/inonjs/workspace/komprai/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/inonjs/workspace/komprai/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/inonjs/workspace/komprai/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/inonjs/workspace/komprai/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/inonjs/workspace/komprai/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/inonjs/workspace/komprai/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/inonjs/workspace/komprai/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/inonjs/workspace/komprai/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/inonjs/workspace/komprai/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/inonjs/workspace/komprai/node_modules/vue/index.mjs';
import { createPathIndexLanguageParser, parseAcceptLanguage } from 'file:///Users/inonjs/workspace/komprai/node_modules/@intlify/utils/dist/index.mjs';
import { parse } from 'file:///Users/inonjs/workspace/komprai/node_modules/cookie-es/dist/index.mjs';
import { createRouterMatcher } from 'file:///Users/inonjs/workspace/komprai/node_modules/vue-router/dist/vue-router.node.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/inonjs/workspace/komprai/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/inonjs/workspace/komprai/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/inonjs/workspace/komprai/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/inonjs/workspace/komprai/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/inonjs/workspace/komprai/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/inonjs/workspace/komprai/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/inonjs/workspace/komprai/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/inonjs/workspace/komprai/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/inonjs/workspace/komprai","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/inonjs/workspace/komprai/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/inonjs/workspace/komprai/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/inonjs/workspace/komprai/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/inonjs/workspace/komprai/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/inonjs/workspace/komprai/public"
      ]
    },
    "http": {
      "domains": []
...
const _67SfQrnEAhTSpsuSEscxxms3fwaFMPokGH7xsjDzrSI = (nitroApp) => {
...
const localeLoaders = {
  br: [
    {
      key: "locale_br_46json_b6fdf69b",
      load: () => Promise.resolve().then(function () { return br$1; }),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_aa46cfa9",
...
const _9zOu5ab1sDWJSVYHZTTt_Yv37jwgMDd_NbQNHZWKpro = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _67SfQrnEAhTSpsuSEscxxms3fwaFMPokGH7xsjDzrSI,
_9zOu5ab1sDWJSVYHZTTt_Yv37jwgMDd_NbQNHZWKpro
];
...
const _1e5lfj = eventHandler((event) => {
...
const _52pfNw = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _Azfchx = _messagesHandler ;
...
const getServerEntry = () => import('file:///Users/inonjs/workspace/komprai/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/inonjs/workspace/komprai/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _n5U7Xt = lazyEventHandler(() => {
...
const _lazy_F0uQtO = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _1e5lfj, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_F0uQtO, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _52pfNw, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _Azfchx, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _n5U7Xt, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_F0uQtO, lazy: true, middleware: false, method: undefined }
];
...
var search$1 = {
	...
	response: {
		...
		aiDisclaimer: {
			warning: "Aviso",
			description: "as informações abaixo são geradas por inteligencia artificial, podem não ser precisas. Verifique o produto antes de comprar."
		}
	}
};
const br = {
...
var search = {
	...
	input: {
		placeholder: "Type product or some store name..."
	},
	actions: {
		search: "Find"
	},
	response: {
		...
		aiDisclaimer: {
			warning: "Warning",
			description: "the information below is generated by artificial intelligence and may not be accurate. Please verify the product before purchasing."
		}
	}
};
const en = {
